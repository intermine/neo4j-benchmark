...
USING PERIODIC COMMIT
LOAD CSV WITH HEADERS FROM "file:/evidencegoannotation.csv" AS row
...
USING PERIODIC COMMIT
LOAD CSV WITH HEADERS FROM "file:/ontologytermsynonyms.csv" AS row
...
USING PERIODIC COMMIT
LOAD CSV WITH HEADERS FROM "file:/ontologyrelation.csv" AS row
...
USING PERIODIC COMMIT
LOAD CSV WITH HEADERS FROM "file:/genesproteins.csv" AS row
